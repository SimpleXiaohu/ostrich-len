...
(assert (= epsilon ""))
(assert (= x_9 (str.replaceall epsilon "\x26\x6c\x74\x3b" "\x3c")))
(assert (= x_19 (str.replaceall x_9 "\x26\x67\x74\x3b" "\x3e")))
(assert (= x_32 (str.replaceall x_19 "\x21\x5c\x72\x5c\x6e\x3f\x21" "\x20")))
...
(assert (= x_65 (str.replaceall literal_49 "\x20" "\x5e\x20")))
...
(assert (> (* 2 (str.indexof x_19 "\x61" 0)) (str.len x_19)))
(check-sat)
(get-model)
