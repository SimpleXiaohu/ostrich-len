...
(assert (= epsilon ""))
(assert (= x_10 (str.replaceall epsilon "\x26\x6c\x74\x3b" "\x3c")))
(assert (= x_21 (str.replaceall x_10 "\x26\x67\x74\x3b" "\x3e")))
(assert (= x_36 (str.replaceall x_21 "\x21\x5c\x72\x5c\x6e\x3f\x21" "\x20")))
...
(assert (= x_73 (str.replaceall literal_54 "\x20" "\x5e\x20")))
