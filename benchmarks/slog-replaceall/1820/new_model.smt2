...
(assert (= x_62 (str.replaceall x_58 "\x3c" "\x26\x6c\x74\x3b")))
(assert (= x_66 (str.replaceall x_62 "\x3e" "\x26\x67\x74\x3b")))
(assert (= x_70 (str.replaceall x_66 "\x22" "\x26\x71\x75\x6f\x74\x3b")))
...
(assert (> (* 2 (str.indexof x_66 "\x61" 0)) (str.len x_66)))
(check-sat)
(get-model)
