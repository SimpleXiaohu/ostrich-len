...
(assert (< qmarkpos 0))
(assert (>= sharppos 0))
(assert (= prothostpath1 (str.substr url1 0 sharppos)))
(assert (= querfrag1 (str.substr url1 sharppos (- (str.len url1) sharppos)))) 
(assert (= querfrag2 (str.replaceall querfrag1 "<script>" "")))
(assert (= url2 (str.++ prothostpath1 querfrag2)))
(assert (str.in.re querfrag2 (re.++ (re.* re.allchar) (str.to.re "<script>") (re.* re.allchar) )))
